...
try:
    # from .antmaze import OfflineAntWrapper, OfflineGoalAntWrapper
    for env_name in [
        'offline_ant_umaze',
        ...
        register(
            id=env_name,
            entry_point="graph_offline_imitation.envs.antmaze:make_offline_ant",
    ...
    print(
        "[research] Could not import Ant Maze envs."
    )
