...
if __name__ == "__main__":
    ...
    parser.add_argument("--checkpoint", type=str, required=False, help="Path to the model",
                                              default= "/home/PJLAB/kang/proj/graph_offline_imitation/results/kitchen+kitchen-kettle_microwave_bottomburner_hinge-v0/goplanv3+10/best_model.pt"
                        )
    parser.add_argument('--render_human', action='store_true', help='whether use human render',
                                              default=True, 
                        )
    ...
    parser.add_argument("--path", type=str, required=False, help="Path to save the gif",
                                             default='/home/PJLAB/kang/proj/graph_offline_imitation/results/kitchen/dwsl/', )
    ...
    config['trainer_kwargs']['eval_kwargs']['render_human']         = True if args.render_human else False
