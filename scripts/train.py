...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", "-c", type=str, default="/home/PJLAB/kang/proj/graph_offline_imitation/configs/kitchen/dwsl.yaml")
    parser.add_argument("--path", "-p", type=str, default="/home/PJLAB/kang/proj/graph_offline_imitation/results/kitchen/dwsl_modify/")
